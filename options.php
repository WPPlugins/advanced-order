...
<div class="wrap">
    ...
    <div id="message" class="updated notice is-dismissible">
        <?php if (count ($_info_update_terms)> 0) : foreach ($_info_update_terms as $_info_term):?>
            <p>Добавлены стартовые данные сортировки для таксономии: <strong><?=$_info_term?></strong>.</p>
        <?php endforeach; endif; ?>

        <?php if (count ($_info_update_posts)> 0) : foreach ($_info_update_posts as $_info_post):?>
            <p>Добавлены стартовые данные сортировки для типа записей: <strong><?=$_info_post?></strong>.</p>
        <?php endforeach; endif; ?>
    ...
    <form action="" method="POST">
        ...
        <div class="card">
            <h3>Выбор таксономий, с которыми работать</h3>
        ...
        <div class="card">
            <h3>Выбор типов записей, с которыми работать</h3>
